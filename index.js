...
function viewDepartments() {
    //pulls all departments from the database
...
function addDepartment() {
    inquirer
        ...
        .then(res => {
            //inserts the new department into from the database
...
function viewRoles() {
    // pulls role id, role title, department of role, and salary of role  from the database
    ...
    db.promise().query('SELECT * FROM department')
        .then(([data]) => {
            ...
            inquirer
                ...
                .then(res => {
                    // inserts the new role into from the database
...
function viewEmployees() {
    //employees' id and name, role title, department, salary, and manager  from the database
    ...
    inquirer
        ...
        .then(res => {
            ...
            db.promise().query('SELECT * FROM role')
                .then(([data]) => {
                    // array to render title of current roles as choices for prompt
                    ...
                    inquirer
                        ...
                        .then(res => {
                            ...
                            db.promise().query('SELECT * FROM employee WHERE manager_id IS NULL')
                                .then(([data]) => {
                                    //maps new array to render titles of current managers as choices for prompt
...
function updateEmployee() {
    //pulls all employees from the database
                        ...
                        .then(([data]) => {
                            ...
                            inquirer
                                .prompt([
                                    ...
                                    const role = res.role
                                    //pulls managers only from the database
                                    db.promise().query('SELECT * FROM employee WHERE manager_id IS NULL')
                                        .then(([data]) => {
                                            ...
                                            inquirer
                                                .prompt([
                                                    ...
                                                    //updates the employee's info in the database
